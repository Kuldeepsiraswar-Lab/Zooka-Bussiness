      ...
      <div className={`flex items-center ${isSidebarCollapsed ? 'justify-center py-4 px-2' : 'justify-start px-4 py-4'} border-b border-slate-800/80 transition-all duration-200`}>
        {!isSidebarCollapsed ? (
          <button
            ...
            title="Zooka Business - Go to Dashboard"
          >
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-indigo-500 via-blue-500 to-cyan-400 flex items-center justify-center text-white font-bold shadow-lg shadow-indigo-500/25 ring-2 ring-indigo-400/30 group-hover:scale-105 transition-transform shrink-0">
